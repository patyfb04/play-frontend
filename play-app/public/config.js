// Identity
window.IDENTITY_SERVICE_URL = "http://4.174.167.15/identity";
window.USERS_API_URL = `${window.IDENTITY_SERVICE_URL}/users`;

// Catalog
window.CATALOG_SERVICE_URL = "http://4.174.167.15/catalog";
window.CATALOG_ITEMS_API_URL = `${window.CATALOG_SERVICE_URL}/items`;

// Inventory
window.INVENTORY_SERVICE_URL = "http://4.174.167.15/inventory";
window.INVENTORY_ITEMS_API_URL = `${window.INVENTORY_SERVICE_URL}/items`;

// Trading
window.TRADING_SERVICE_URL = "http://4.174.167.15/trading";
